 ...
 const EventPlanner = () => {
  ...
  <div className="event-planner-container">
     ...
     <section className="description">
         <p>
             Planifiez et organisez vos événements sans effort avec Event Planner. Des
             anniversaires aux réunions d'entreprise, nous avons tout ce qu'il vous faut.
         </p>
     ...
     <section className="events_categories">
         <ul>
             ...
             <li>Baby showers</li>
             <li>Fêtes de remise de diplômes</li>
     ...
     <section className="features">
         ...
         <ul>
             ...
             <li>Gestion de liste d'invités</li>
     ...
     <section className="testimonials">
         ...
         <div className="testimonial">
             <p>"Event Planner a rendu l'organisation de mon mariage très facile. Hautement recommandé!"</p>
